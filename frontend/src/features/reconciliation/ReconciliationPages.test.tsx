...
const run = {
  id: '7', billingPeriodId: '10', status: 'COMPLETED' as const, algorithmVersion: 'M6_PERIOD_PROVIDER_CURRENCY_V1',
  toleranceAmount: '0.00000000', basisHash: 'hash', summary: { totalKeys: 3, matchedCount: 2, discrepancyCount: 1 },
...
describe('ReconciliationPage', () => {
  it('uses the canonical discrepancy count and removes the unsupported provider filter', async () => {
    ...
    expect(await screen.findByText('M6_PERIOD_PROVIDER_CURRENCY_V1')).toBeInTheDocument()
