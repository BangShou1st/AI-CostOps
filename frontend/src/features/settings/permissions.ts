...
export const SETTINGS_NAV: readonly SettingsNavEntry[] = [
  ...
  { path: '/settings/providers', label: '服务商总览', readPermission: 'PROVIDER_ACCOUNT_READ' },
  { path: '/settings/provider-connections', label: '连接配置', readPermission: 'PROVIDER_ACCOUNT_READ' },
  { path: '/settings/provider-models', label: '模型目录', readPermission: 'PROVIDER_ACCOUNT_READ' },
