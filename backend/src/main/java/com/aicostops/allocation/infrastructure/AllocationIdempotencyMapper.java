...
/**
 * Reservation/replay rows for idempotent allocation commands, bound to the
 * existing generic {@code api_idempotency} table (no new schema).
 */
@Mapper
public interface AllocationIdempotencyMapper {
    ...
    record IdempotencyRow(
            long id, long orgId, long actorMemberId, String operation, String idempotencyKey,
