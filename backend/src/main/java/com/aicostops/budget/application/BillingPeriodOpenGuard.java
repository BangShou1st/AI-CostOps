 ...
 * not OPEN yields a {@code PERIOD_NOT_OPEN} problem.
 */
public interface BillingPeriodOpenGuard {
     ...
     *         {@code STATE_CONFLICT} when no period covers the time, or code
     *         {@code PERIOD_NOT_OPEN} when the covering period is CLOSING or
     *         CLOSED
     */
